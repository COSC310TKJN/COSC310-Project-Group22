    ...
    <div className="min-h-[100dvh] flex flex-col">
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-8">
        {location.state?.message && (
          <div className="mb-4 flex items-center justify-between rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-sm text-amber-900">
            <span>{location.state.message}</span>
            <button
              type="button"
              className="ml-3 text-xs font-semibold text-amber-800 hover:text-amber-950"
              onClick={dismissRouteMessage}
            >
              Dismiss
            </button>
          </div>
